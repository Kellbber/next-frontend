...
export default function Navbar() {
  ...
  return (
    <FlowbiteNavbar fluid rounded>
      ...
      <NavbarCollapse>
        <Link href={`/?walletId=${wallet_id}`} passHref legacyBehavior>
          <NavbarLink className="text-xl">Carteira</NavbarLink>
        </Link>
        <Link href={`/assets/?walletId=${wallet_id}`} passHref legacyBehavior>
          <NavbarLink className="text-xl">Ativos</NavbarLink>
        </Link>
        <Link href={`/orders?walletId=${wallet_id}`} passHref legacyBehavior>
